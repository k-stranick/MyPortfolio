...
export class AppComponent {
  showContent = false;
  // After static imports at the top:
  aboutComponent: typeof AboutComponent | null = null;
  resumeComponent: typeof ResumeComponent | null = null;
  coverLetterComponent: typeof CoverLetterComponent | null = null;
  artifactsComponent: typeof CourseArtifactsComponent | null = null;
  demonstrationsComponent: typeof DemonstrationsComponent | null = null;
  awardsComponent: typeof AwardsComponent | null = null;
  referencesComponent: typeof ReferencesComponent | null = null;
  ...
  async onContentToggled(isVisible: boolean) {
    ...
    if (isVisible) {
      ...
      this.coverLetterComponent = CoverLetterComponent;
      this.artifactsComponent = CourseArtifactsComponent;
      this.demonstrationsComponent = DemonstrationsComponent;
      this.awardsComponent = AwardsComponent;
      this.referencesComponent = ReferencesComponent;
