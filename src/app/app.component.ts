...
// ✅ Statically import all "lazy" components
...
export class AppComponent {
  ...
  // Component references for ngComponentOutlet
  aboutComponent: any = null;
  resumeComponent: any = null;
  coverLetterComponent: any = null;
  artifactsComponent: any = null;
  demonstrationsComponent: any = null;
  awardsComponent: any = null;
  referencesComponent: any = null;

  async onContentToggled(isVisible: boolean): Promise<void> {
    this.showContent = isVisible;

    if (isVisible) {
      // ✅ Directly assign statically imported components
